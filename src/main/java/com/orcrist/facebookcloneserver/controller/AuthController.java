...
import com.orcrist.facebookcloneserver.service.auth.AuthService;
...
public class AuthController {
    ...
    public ApiResponse register(@RequestBody @Valid RegisterDto dto) throws ParseException, MessagingException, jakarta.mail.MessagingException {
